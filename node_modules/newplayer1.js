          ...
          if (position.id != 's1') {
            ...
            if (obstacles > 1) {
              if (startpoint === 806.4516) {
                force = 830 + ((obstacles - 1) * 300) + 300;
                if (force > 4000) {
                  force = 4000;
                }
              } else {
                force = 830 + ((obstacles - 1) * 300);
                if (force > 4000) {
                  force = 4000;
                }
              }
              ...
              if ((Math.abs(strikerm - slope)) > 8) {
                force = (sortbydistanceArray[i].distance / 100) * 100 + 1200;
              } else {
                if (startpoint === 806.4516) {
                  force = 1200 + ((sortbydistanceArray[i].distance / 100) * 150);
                  if (force > 4000) {
                    force = 4000;
                  }
                } else {
                  force = (sortbydistanceArray[i].distance / 100) * 60 + 870;
                }
